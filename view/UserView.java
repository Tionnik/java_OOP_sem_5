...
import java_OOP_sem_5.base_controller.BaseСontroller;
...
public class UserView {
    ...
    public void addTeacher(){
        ...
        new BaseСontroller().newTeacher(name, LastName, birthday, disciplines, rating, faculty);
    }
    ...
    public void addStudent(){
        ...
        new BaseСontroller().NewStudent(name, LastName, birthday, group, speciality, averageMark);
    }    
}
